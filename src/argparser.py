...
def argument_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "-rs", "--random-seed", dest="random_seed", default=42, type=int
    )
    ...
    parser.add_argument(
        "-lr", "--learning-rate", dest="learning_rate", default=1e-4, type=float
    )

    parser.add_argument(
        "-ne", "--num-episodes", dest="num_episodes", default=100_000, type=int
    )
    ...
    parser.add_argument(
        "-hu", "--hidden-units", dest="num_hidden_units", default=128, type=int
    )
